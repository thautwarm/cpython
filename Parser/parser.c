...
#define _loop0_48_type 1206
#define _gather_47_type 1207
#define _loop0_50_type 1208
#define _gather_49_type 1209
#define _tmp_51_type 1210
#define _loop1_52_type 1211
#define _tmp_53_type 1212
#define _tmp_54_type 1213
#define _tmp_55_type 1214
#define _tmp_56_type 1215
#define _tmp_57_type 1216
#define _loop0_58_type 1217
#define _loop0_59_type 1218
#define _loop0_60_type 1219
#define _loop1_61_type 1220
#define _loop0_62_type 1221
#define _loop1_63_type 1222
#define _loop1_64_type 1223
#define _loop1_65_type 1224
#define _loop0_66_type 1225
#define _loop1_67_type 1226
#define _loop0_68_type 1227
#define _loop1_69_type 1228
#define _loop0_70_type 1229
#define _loop1_71_type 1230
#define _loop1_72_type 1231
#define _tmp_73_type 1232
#define _loop0_75_type 1233
#define _gather_74_type 1234
#define _loop1_76_type 1235
#define _loop0_78_type 1236
#define _gather_77_type 1237
#define _loop1_79_type 1238
#define _loop0_80_type 1239
#define _loop0_81_type 1240
#define _loop0_82_type 1241
#define _loop1_83_type 1242
#define _loop0_84_type 1243
#define _loop1_85_type 1244
#define _loop1_86_type 1245
#define _loop1_87_type 1246
#define _loop0_88_type 1247
#define _loop1_89_type 1248
#define _loop0_90_type 1249
#define _loop1_91_type 1250
#define _loop0_92_type 1251
#define _loop1_93_type 1252
#define _loop1_94_type 1253
#define _loop1_95_type 1254
#define _loop1_96_type 1255
#define _tmp_97_type 1256
#define _loop0_99_type 1257
#define _gather_98_type 1258
#define _tmp_100_type 1259
#define _tmp_101_type 1260
#define _tmp_102_type 1261
#define _tmp_103_type 1262
#define _loop1_104_type 1263
#define _tmp_105_type 1264
#define _tmp_106_type 1265
#define _loop0_108_type 1266
#define _gather_107_type 1267
#define _loop1_109_type 1268
#define _loop0_110_type 1269
#define _loop0_111_type 1270
#define _tmp_112_type 1271
#define _tmp_113_type 1272
...
#define _loop0_121_type 1279
#define _gather_120_type 1280
#define _loop0_122_type 1281
#define _loop0_124_type 1282
#define _gather_123_type 1283
#define _tmp_125_type 1284
#define _loop0_127_type 1285
#define _gather_126_type 1286
#define _loop0_129_type 1287
#define _gather_128_type 1288
...
#define _loop0_137_type 1296
#define _tmp_138_type 1297
#define _loop0_139_type 1298
...
#define _tmp_152_type 1311
#define _tmp_153_type 1312
#define _tmp_154_type 1313
#define _tmp_155_type 1314
#define _tmp_156_type 1315
#define _tmp_157_type 1316
#define _loop1_158_type 1317
#define _loop1_159_type 1318
#define _tmp_160_type 1319
#define _tmp_161_type 1320
#define _tmp_162_type 1321
#define _tmp_163_type 1322
...
//     | 'with' (',' [NEWLINE INDENT?]).with_item+ ':' TYPE_COMMENT? NEWLINE statements DEDENT
//     | ASYNC 'with' '(' ','.with_item+ ','? ')' ':' block
//     | ASYNC 'with' ','.with_item+ ':' TYPE_COMMENT? block
//     | ASYNC 'with' (',' [NEWLINE INDENT?]).with_item+ ':' TYPE_COMMENT? NEWLINE statements DEDENT
static stmt_ty
with_stmt_rule(Parser *p)
{
    ...
    { // 'with' (',' [NEWLINE INDENT?]).with_item+ ':' TYPE_COMMENT? NEWLINE statements DEDENT
        ...
        D(fprintf(stderr, "%*c> with_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "'with' (',' [NEWLINE INDENT?]).with_item+ ':' TYPE_COMMENT? NEWLINE statements DEDENT"));
        Token * _keyword;
        Token * _literal;
        asdl_seq * a;
        asdl_seq* b;
        ...
        if (
            (_keyword = _PyPegen_expect_token(p, 519))  // token='with'
            &&
            (a = _gather_43_rule(p))  // (',' [NEWLINE INDENT?]).with_item+
            &&
            (_literal = _PyPegen_expect_token(p, 11))  // token=':'
            &&
            (tc = _PyPegen_expect_token(p, TYPE_COMMENT), 1)  // TYPE_COMMENT?
            ...
            (newline_var = _PyPegen_expect_token(p, NEWLINE))  // token='NEWLINE'
            &&
            (b = statements_rule(p))  // statements
            &&
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s with_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "'with' (',' [NEWLINE INDENT?]).with_item+ ':' TYPE_COMMENT? NEWLINE statements DEDENT"));
    }
    { // ASYNC 'with' '(' ','.with_item+ ','? ')' ':' block
        if (p->error_indicator) {
            D(p->level--);
    ...
    { // ASYNC 'with' (',' [NEWLINE INDENT?]).with_item+ ':' TYPE_COMMENT? NEWLINE statements DEDENT
        ...
        D(fprintf(stderr, "%*c> with_stmt[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "ASYNC 'with' (',' [NEWLINE INDENT?]).with_item+ ':' TYPE_COMMENT? NEWLINE statements DEDENT"));
        Token * _keyword;
        Token * _literal;
        asdl_seq * a;
        Token * async_var;
        ...
        if (
            ...
            (_keyword = _PyPegen_expect_token(p, 519))  // token='with'
            &&
            (a = _gather_49_rule(p))  // (',' [NEWLINE INDENT?]).with_item+
            &&
            (_literal = _PyPegen_expect_token(p, 11))  // token=':'
            &&
            (tc = _PyPegen_expect_token(p, TYPE_COMMENT), 1)  // TYPE_COMMENT?
        ...
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s with_stmt[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "ASYNC 'with' (',' [NEWLINE INDENT?]).with_item+ ':' TYPE_COMMENT? NEWLINE statements DEDENT"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
with_item_rule(Parser *p)
{
    ...
    { // expression 'as' target &(',' | ')' | ':')
        ...
        if (
            ...
            &&
            _PyPegen_lookahead(1, _tmp_51_rule, p)
        )
        {
...
try_stmt_rule(Parser *p)
{
    ...
    { // 'try' ':' block except_block+ else_block? finally_block?
        ...
        if (
            ...
            (b = block_rule(p))  // block
            &&
            (ex = _loop1_52_rule(p))  // except_block+
            &&
            (el = else_block_rule(p), 1)  // else_block?
            &&
...
raise_stmt_rule(Parser *p)
{
    ...
    { // 'raise' expression ['from' expression]
        ...
        if (
            ...
            (a = expression_rule(p))  // expression
            &&
            (b = _tmp_54_rule(p), 1)  // ['from' expression]
        )
        {
...
func_type_comment_rule(Parser *p)
{
    ...
    { // NEWLINE TYPE_COMMENT &(NEWLINE INDENT)
        ...
        if (
            ...
            &&
            _PyPegen_lookahead(1, _tmp_57_rule, p)
        )
        {
...
parameters_rule(Parser *p)
{
    ...
    { // slash_no_default param_no_default* param_with_default* star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_58_rule(p))  // param_no_default*
            &&
            (c = _loop0_59_rule(p))  // param_with_default*
            &&
    ...
    { // param_no_default+ param_with_default* star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_62_rule(p))  // param_with_default*
            &&
            (c = star_etc_rule(p), 1)  // star_etc?
        )
        {
    ...
    { // param_with_default+ star_etc?
        ...
        void *b;
        if (
            (a = _loop1_63_rule(p))  // param_with_default+
            &&
...
slash_no_default_rule(Parser *p)
{
    ...
    { // param_no_default+ '/' ','
        ...
        asdl_seq * a;
        if (
            (a = _loop1_64_rule(p))  // param_no_default+
            &&
    ...
    { // param_no_default+ '/' &')'
        ...
        asdl_seq * a;
        if (
            (a = _loop1_65_rule(p))  // param_no_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
...
slash_with_default_rule(Parser *p)
{
    ...
    { // param_no_default* param_with_default+ '/' &')'
        ...
        asdl_seq * b;
        if (
            (a = _loop0_68_rule(p))  // param_no_default*
            &&
            (b = _loop1_69_rule(p))  // param_with_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 8)  // token=')'
...
star_etc_rule(Parser *p)
{
    ...
    { // '*' param_no_default param_maybe_default* kwds?
        ...
        if (
            ...
            &&
            (b = _loop0_70_rule(p))  // param_maybe_default*
            &&
    ...
    { // '*' ',' param_maybe_default+ kwds?
        ...
        if (
            ...
            (_literal_1 = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _loop1_71_rule(p))  // param_maybe_default+
            &&
            (c = kwds_rule(p), 1)  // kwds?
        )
        {
...
decorators_rule(Parser *p)
{
    ...
    { // (('@' named_expression NEWLINE))+
        ...
        asdl_seq * a;
        if (
            (a = _loop1_72_rule(p))  // (('@' named_expression NEWLINE))+
        )
        {
...
expressions_list_rule(Parser *p)
{
    ...
    { // ','.star_expression+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_74_rule(p))  // ','.star_expression+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_expressions_rule(Parser *p)
{
    ...
    { // star_expression ((',' star_expression))+ ','?
        ...
        if (
            ...
            &&
            (b = _loop1_76_rule(p))  // ((',' star_expression))+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
star_named_expressions_rule(Parser *p)
{
    ...
    { // ','.star_named_expression+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_77_rule(p))  // ','.star_named_expression+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
lambda_parameters_rule(Parser *p)
{
    ...
    { // lambda_slash_no_default lambda_param_no_default* lambda_param_with_default* lambda_star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_80_rule(p))  // lambda_param_no_default*
            &&
            (c = _loop0_81_rule(p))  // lambda_param_with_default*
            &&
    ...
    { // lambda_param_no_default+ lambda_param_with_default* lambda_star_etc?
        ...
        if (
            ...
            &&
            (b = _loop0_84_rule(p))  // lambda_param_with_default*
            &&
            (c = lambda_star_etc_rule(p), 1)  // lambda_star_etc?
        )
        {
    ...
    { // lambda_param_with_default+ lambda_star_etc?
        ...
        void *b;
        if (
            (a = _loop1_85_rule(p))  // lambda_param_with_default+
            &&
...
lambda_slash_no_default_rule(Parser *p)
{
    ...
    { // lambda_param_no_default+ '/' ','
        ...
        asdl_seq * a;
        if (
            (a = _loop1_86_rule(p))  // lambda_param_no_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
            (_literal_1 = _PyPegen_expect_token(p, 12))  // token=','
    ...
    { // lambda_param_no_default+ '/' &':'
        ...
        asdl_seq * a;
        if (
            (a = _loop1_87_rule(p))  // lambda_param_no_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
...
lambda_slash_with_default_rule(Parser *p)
{
    ...
    { // lambda_param_no_default* lambda_param_with_default+ '/' &':'
        ...
        asdl_seq * b;
        if (
            (a = _loop0_90_rule(p))  // lambda_param_no_default*
            &&
            (b = _loop1_91_rule(p))  // lambda_param_with_default+
            &&
            (_literal = _PyPegen_expect_token(p, 17))  // token='/'
            &&
            _PyPegen_lookahead_with_int(1, _PyPegen_expect_token, p, 11)  // token=':'
...
lambda_star_etc_rule(Parser *p)
{
    ...
    { // '*' lambda_param_no_default lambda_param_maybe_default* lambda_kwds?
        ...
        if (
            ...
            &&
            (b = _loop0_92_rule(p))  // lambda_param_maybe_default*
            &&
    ...
    { // '*' ',' lambda_param_maybe_default+ lambda_kwds?
        ...
        if (
            ...
            (_literal_1 = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (b = _loop1_93_rule(p))  // lambda_param_maybe_default+
            &&
            (c = lambda_kwds_rule(p), 1)  // lambda_kwds?
        )
        {
...
disjunction_rule(Parser *p)
{
    ...
    { // conjunction (('or' conjunction))+
        ...
        if (
            ...
            &&
            (b = _loop1_94_rule(p))  // (('or' conjunction))+
        )
        {
...
conjunction_rule(Parser *p)
{
    ...
    { // inversion (('and' inversion))+
        ...
        if (
            ...
            &&
            (b = _loop1_95_rule(p))  // (('and' inversion))+
        )
        {
...
comparison_rule(Parser *p)
{
    ...
    { // bitwise_or compare_op_bitwise_or_pair+
        ...
        if (
            (a = bitwise_or_rule(p))  // bitwise_or
            &&
            (b = _loop1_96_rule(p))  // compare_op_bitwise_or_pair+
        )
        {
...
slice_rule(Parser *p)
{
    ...
    { // expression? ':' expression? [':' expression?]
        ...
        if (
            ...
            &&
            (c = _tmp_100_rule(p), 1)  // [':' expression?]
        )
        {
...
atom_rule(Parser *p)
{
    ...
    { // &'(' (tuple | group | genexp)
        ...
        if (
            ...
            &&
            (_tmp_101_var = _tmp_101_rule(p))  // tuple | group | genexp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'(' (tuple | group | genexp)"));
            _res = _tmp_101_var;
    ...
    { // &'[' (list | listcomp)
        ...
        if (
            ...
            &&
            (_tmp_102_var = _tmp_102_rule(p))  // list | listcomp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'[' (list | listcomp)"));
            _res = _tmp_102_var;
    ...
    { // &'{' (dict | set | dictcomp | setcomp)
        ...
        if (
            ...
            &&
            (_tmp_103_var = _tmp_103_rule(p))  // dict | set | dictcomp | setcomp
        )
        {
            D(fprintf(stderr, "%*c+ atom[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "&'{' (dict | set | dictcomp | setcomp)"));
            _res = _tmp_103_var;
...
tuple_rule(Parser *p)
{
    ...
    { // '(' [star_named_expression ',' star_named_expressions?] ')'
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
            &&
            (a = _tmp_105_rule(p), 1)  // [star_named_expression ',' star_named_expressions?]
            &&
            (_literal_1 = _PyPegen_expect_token(p, 8))  // token=')'
        )
        {
...
group_rule(Parser *p)
{
    ...
    { // '(' (yield_expr | named_expression) ')'
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 7))  // token='('
            &&
            (a = _tmp_106_rule(p))  // yield_expr | named_expression
            &&
            (_literal_1 = _PyPegen_expect_token(p, 8))  // token=')'
        )
        {
...
double_starred_kvpairs_rule(Parser *p)
{
    ...
    { // ','.double_starred_kvpair+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_107_rule(p))  // ','.double_starred_kvpair+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
for_if_clauses_rule(Parser *p)
{
    ...
    { // for_if_clause+
        ...
        asdl_seq * _loop1_109_var;
        if (
            (_loop1_109_var = _loop1_109_rule(p))  // for_if_clause+
        )
        {
...
for_if_clause_rule(Parser *p)
{
    ...
    { // ASYNC 'for' star_targets 'in' ~ disjunction (('if' disjunction))*
        ...
        if (
            ...
            (b = disjunction_rule(p))  // disjunction
            &&
            (c = _loop0_110_rule(p))  // (('if' disjunction))*
        )
        {
    ...
    { // 'for' star_targets 'in' ~ disjunction (('if' disjunction))*
        ...
        if (
            ...
            (b = disjunction_rule(p))  // disjunction
            &&
            (c = _loop0_111_rule(p))  // (('if' disjunction))*
        )
        {
            D(fprintf(stderr, "%*c+ for_if_clause[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "'for' star_targets 'in' ~ disjunction (('if' disjunction))*"));
...
star_targets_seq_rule(Parser *p)
{
    ...
    { // ','.star_target+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_123_rule(p))  // ','.star_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
del_targets_rule(Parser *p)
{
    ...
    { // ','.del_target+ ','?
        ...
        asdl_seq * a;
        if (
            (a = _gather_126_rule(p))  // ','.del_target+
            &&
            (_opt_var = _PyPegen_expect_token(p, 12), 1)  // ','?
        )
        {
...
invalid_assignment_rule(Parser *p)
{
    ...
    { // expression ':' expression ['=' annotated_rhs]
        ...
        if (
            ...
            (expression_var = expression_rule(p))  // expression
            &&
            (_opt_var = _tmp_132_rule(p), 1)  // ['=' annotated_rhs]
        )
        {
            D(fprintf(stderr, "%*c+ invalid_assignment[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "expression ':' expression ['=' annotated_rhs]"));
...
// _loop0_44: (',' [NEWLINE INDENT?]) with_item
static asdl_seq *
_loop0_44_rule(Parser *p)
{
    ...
    ssize_t _children_capacity = 1;
    ssize_t _n = 0;
    { // (',' [NEWLINE INDENT?]) with_item
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _loop0_44[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "(',' [NEWLINE INDENT?]) with_item"));
        void *_tmp_146_var;
        withitem_ty elem;
        while (
            (_tmp_146_var = _tmp_146_rule(p))  // ',' [NEWLINE INDENT?]
            &&
            (elem = with_item_rule(p))  // with_item
        )
        {
        ...
        D(fprintf(stderr, "%*c%s _loop0_44[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "(',' [NEWLINE INDENT?]) with_item"));
    }
    asdl_seq *_seq = _Py_asdl_seq_new(_n, p->arena);
    if (!_seq) {
        PyMem_Free(_children);
...
_gather_47_rule(Parser *p)
{
    ...
    { // with_item _loop0_48
        ...
        D(fprintf(stderr, "%*c> _gather_47[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "with_item _loop0_48"));
        withitem_ty elem;
        asdl_seq * seq;
        if (
            (elem = with_item_rule(p))  // with_item
        ...
        D(fprintf(stderr, "%*c%s _gather_47[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "with_item _loop0_48"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _loop0_50: (',' [NEWLINE INDENT?]) with_item
static asdl_seq *
_loop0_50_rule(Parser *p)
{
    ...
    { // (',' [NEWLINE INDENT?]) with_item
        ...
        withitem_ty elem;
        while (
            (_tmp_147_var = _tmp_147_rule(p))  // ',' [NEWLINE INDENT?]
            &&
            (elem = with_item_rule(p))  // with_item
        )
        {
...
_gather_49_rule(Parser *p)
{
    ...
    { // with_item _loop0_50
        ...
        D(fprintf(stderr, "%*c> _gather_49[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "with_item _loop0_50"));
        withitem_ty elem;
        asdl_seq * seq;
        if (
            (elem = with_item_rule(p))  // with_item
        ...
        D(fprintf(stderr, "%*c%s _gather_49[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "with_item _loop0_50"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_tmp_57_rule(Parser *p)
{
    ...
    { // NEWLINE INDENT
        ...
        D(fprintf(stderr, "%*c> _tmp_57[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "NEWLINE INDENT"));
        Token * indent_var;
        Token * newline_var;
        if (
            (newline_var = _PyPegen_expect_token(p, NEWLINE))  // token='NEWLINE'
        ...
        {
            D(fprintf(stderr, "%*c+ _tmp_57[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "NEWLINE INDENT"));
            _res = _PyPegen_dummy_name(p, newline_var, indent_var);
            goto done;
        }
        p->mark = _mark;
        D(fprintf(stderr, "%*c%s _tmp_57[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "NEWLINE INDENT"));
    }
    _res = NULL;
  done:
...
// _loop1_72: ('@' named_expression NEWLINE)
static asdl_seq *
...
// _gather_74: star_expression _loop0_75
static asdl_seq *
_gather_74_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // star_expression _loop0_75
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_74[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_expression _loop0_75"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_expression_rule(p))  // star_expression
        ...
        D(fprintf(stderr, "%*c%s _gather_74[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_expression _loop0_75"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _loop0_78: ',' star_named_expression
static asdl_seq *
...
// _gather_77: star_named_expression _loop0_78
static asdl_seq *
_gather_77_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // star_named_expression _loop0_78
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_77[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "star_named_expression _loop0_78"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = star_named_expression_rule(p))  // star_named_expression
        ...
        D(fprintf(stderr, "%*c%s _gather_77[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "star_named_expression _loop0_78"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _loop0_80: lambda_param_no_default
static asdl_seq *
...
// _loop0_84: lambda_param_with_default
static asdl_seq *
...
// _loop1_86: lambda_param_no_default
static asdl_seq *
...
// _loop1_87: lambda_param_no_default
static asdl_seq *
...
// _loop1_91: lambda_param_with_default
static asdl_seq *
...
// _loop0_92: lambda_param_maybe_default
static asdl_seq *
...
// _loop1_93: lambda_param_maybe_default
static asdl_seq *
...
// _loop1_96: compare_op_bitwise_or_pair
static asdl_seq *
...
_gather_98_rule(Parser *p)
{
    ...
    { // slice _loop0_99
        ...
        D(fprintf(stderr, "%*c> _gather_98[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "slice _loop0_99"));
        expr_ty elem;
        asdl_seq * seq;
        if (
            (elem = slice_rule(p))  // slice
        ...
        D(fprintf(stderr, "%*c%s _gather_98[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "slice _loop0_99"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
// _tmp_105: star_named_expression ',' star_named_expressions?
static void *
...
// _tmp_106: yield_expr | named_expression
static void *
...
_gather_107_rule(Parser *p)
{
    ...
    asdl_seq * _res = NULL;
    int _mark = p->mark;
    { // double_starred_kvpair _loop0_108
        if (p->error_indicator) {
            D(p->level--);
            return NULL;
        }
        D(fprintf(stderr, "%*c> _gather_107[%d-%d]: %s\n", p->level, ' ', _mark, p->mark, "double_starred_kvpair _loop0_108"));
        KeyValuePair* elem;
        asdl_seq * seq;
        if (
            (elem = double_starred_kvpair_rule(p))  // double_starred_kvpair
        ...
        D(fprintf(stderr, "%*c%s _gather_107[%d-%d]: %s failed!\n", p->level, ' ',
                  p->error_indicator ? "ERROR!" : "-", _mark, p->mark, "double_starred_kvpair _loop0_108"));
    }
    _res = NULL;
  done:
    D(p->level--);
...
_tmp_138_rule(Parser *p)
{
    ...
    { // param_with_default+
        ...
        if (
            (_loop1_158_var = _loop1_158_rule(p))  // param_with_default+
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_138[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "param_with_default+"));
            _res = _loop1_158_var;
...
_tmp_146_rule(Parser *p)
{
    ...
    { // ',' [NEWLINE INDENT?]
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_opt_var = _tmp_162_rule(p), 1)  // [NEWLINE INDENT?]
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_146[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "',' [NEWLINE INDENT?]"));
            _res = _PyPegen_dummy_name(p, _literal, _opt_var);
            goto done;
        }
        p->mark = _mark;
...
_tmp_147_rule(Parser *p)
{
    ...
    { // ',' [NEWLINE INDENT?]
        ...
        if (
            (_literal = _PyPegen_expect_token(p, 12))  // token=','
            &&
            (_opt_var = _tmp_163_rule(p), 1)  // [NEWLINE INDENT?]
        )
        {
...
_tmp_162_rule(Parser *p)
{
    ...
    { // NEWLINE INDENT?
        ...
        if (
            (newline_var = _PyPegen_expect_token(p, NEWLINE))  // token='NEWLINE'
            &&
            (_opt_var = _PyPegen_expect_token(p, INDENT), 1)  // INDENT?
        )
        {
            D(fprintf(stderr, "%*c+ _tmp_162[%d-%d]: %s succeeded!\n", p->level, ' ', _mark, p->mark, "NEWLINE INDENT?"));
            _res = _PyPegen_dummy_name(p, newline_var, _opt_var);
            goto done;
        }
        p->mark = _mark;
